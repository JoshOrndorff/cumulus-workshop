...
that we will use to launch our first parachains and make cross-chain asset transfers, and as a
starting point for developing our own parachains. Perform these steps in your typical workspace
directory.
