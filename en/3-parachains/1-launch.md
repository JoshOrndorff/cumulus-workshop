...
Note that the `parachain-collator` command used below comes from the substrate-developer-hub/substrate-parachain-template repo that we set up in the Preparation/Compiling step.
